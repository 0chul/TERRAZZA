...
const INITIAL_CHECKLIST: ChecklistItem[] = [
  ...
  { id: '4', item: '식기세척기', model: '', quantity: 1, price: 1100000, note: '신품,렉포함' },
  ...
  { id: '9', item: '컨벡션오븐', model: '소프트밀', quantity: 1, price: 1200000, note: '중고,선반별도' },
  { id: '10', item: '전자동커피머신', model: 'WMF(독일)', quantity: 1, price: 12000000, note: '중고' },
  { id: '11', item: '전자동커피머신', model: '세코(이태리)', quantity: 1, price: 4200000, note: '중고' },
  { id: '12', item: '전자동커피머신', model: '닥터커피F15', quantity: 1, price: 1800000, note: '신품' },
  { id: '13', item: '정수필터', model: 'FN6', quantity: 1, price: 150000, note: '신품,헤드포함' },
  { id: '14', item: '정수필터', model: 'PF6', quantity: 1, price: 100000, note: '신품,헤드포함' },
  { id: '15', item: '그라인더', model: '말코닉 EK43', quantity: 1, price: 2500000, note: '중고' },
  { id: '16', item: '그라인더', model: '메져슈퍼졸리', quantity: 1, price: 600000, note: '중고' },
